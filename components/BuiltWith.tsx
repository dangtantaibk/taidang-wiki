  ...
  return (
    <div className="flex items-center space-x-1">
      ...
      <div className="flex space-x-1.5">
        <Link href="https://nextjs.org?ref=taidang.wiki">
          <BrandIcon type="NextJS" className="h-5 w-5" />
        </Link>
        <Link href="https://tailwindcss.com?ref=taidang.wiki">
          <BrandIcon type="TailwindCSS" className="h-5 w-5" />
        </Link>
        <Link href="https://www.prisma.io?ref=taidang.wiki">
          <BrandIcon type="Prisma" className="h-5 w-5" />
        </Link>
        <Link href="https://www.typescriptlang.org?ref=taidang.wiki">
          <BrandIcon type="Typescript" className="h-5 w-5" />
        </Link>
        <Link href="https://umami.is?ref=taidang.wiki" className="pl-px">
